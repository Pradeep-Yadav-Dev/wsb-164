...
export default function Purchase() {
    ...
    let isAlreadyExist = cart.some((v) => v.id == singleProduct?.id)
                    ...
                    <div className=" border  border-gray-100 p-13">
                        ...
                        <div className="flex mt-[10px]">
                            <div>
                                {isAlreadyExist == true
                                    ?
                                    <button disabled={isAlreadyExist == true} type="button" class="focus:outline-none text-white bg-[red]  font-bold rounded-lg text-sm px-8 py-4 me-2 mb-2 ">Added</button>
                                    :
