...
export default function Header() {
    ...
    // login work
    let websiteToken = Cookies.get("blinkit-token")
            ...
            <header className='shadow-[0_0_10px_1px_#ccc] grid lg:grid-cols-[10%_25%_auto_10%_10%_10%]  px-[10px] py-[20px] text-center fixed top-0 left-0 w-full z-50 bg-white  items-center ' >
                ...
                <div className="">
                    ...
                    {websiteToken == undefined ?
                        ...
                        :
                        <button onClick={logoutWork} > Logout </button>
                    }

                </div>
                <div className="">
                    <button type="button" className=" w-[75%] text-[18px] flex justify-between items-center focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><BsCart3 className='text-[20px] font-bold ' /> Items </button>
                </div>

                <Link to={"/Cart"}>

                    <div className="">
                        <button type="button" className=" w-[85%] text-[18px] flex justify-between items-center focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"><BsCart3 className='text-[16px] font-bold ' /> My Cart  <sup> {cart.length > 0 ? cart.length : ""} </sup>  </button>
                    </div>
