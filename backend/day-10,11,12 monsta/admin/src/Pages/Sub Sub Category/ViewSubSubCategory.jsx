...
export default function ViewCategory() {
  ...
  useEffect(() => {
    axios.get(`${import.meta.env.VITE_API_URL}sub-sub-category/view`)
      .then((ress) => {
                      ...
                      return (
                        <>
                          <tr class="bg-white  dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class=" py-4">
                              <img class="w-10 h-10 rounded-full" src={filePath+v.subSubCategoryImage} alt="Jese image" />
                            </td>
                            <td class=" py-4">
                              {v.order}
                            </td>
