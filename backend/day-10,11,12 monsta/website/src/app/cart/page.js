...
export default function page() {
    ...
    let { totalAmount, setTotalAmount } = useContext(Econtext)
    ...
    useEffect(() => {
        axios.get(`${process.env.NEXT_PUBLIC_URL}cart/view`,
            ...
            .then((ress) => {
                setCartItems(ress.data.data.items)
                                                ...
                                                return (
                                                    <>
                                                        <tr>
                                                            ...
                                                            <td className="product-price">Rs.  {v?.price}</td>

                                                            <td className="product_quantity">
                                                                <label>Quantity</label>
                                                                <input min="0" max="100" defaultValue={v?.quantity} type="number" />
                                                            </td>

                                                            <td className="product_total">Rs.  {(v?.price) * v?.quantity} </td>
                                                        </tr>
                                                    </>
                                                )
                                            })}
                            ...
                            <div className="coupon_code right">
                                ...
                                <div className="coupon_inner">
                                    <div className="cart_subtotal">
                                        <p>Subtotal</p>
                                        <p className="cart_amount">Rs {totalAmount}.</p>
                                    </div>
                                    <div className="cart_subtotal">
                                        <p>Discount (-)</p>
                                    ...
                                    <div className="cart_subtotal">
                                        <p>Total</p>
                                        <p className="cart_amount grand_total">Rs {totalAmount}.</p>
                                    </div>
