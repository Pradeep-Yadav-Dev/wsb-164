...
export default function LeftRight({categoryData}) {
  return (
    <div>
      ...
      <Container>
        <Row>
          ...
          <Col xs={{ order: 1 }} md={{ order: 2 }} className="">
            <RightSide categoryData={categoryData} />
          </Col>
        </Row>
      </Container>
    </div>
      ...
      <Col>
        ...
        <div className="single_product">
          <div className="product_thumb">
            <Link className="primary_img" href={`/product-details/${v.slug}`}>
              <img src={`http://localhost:5600/uploads/${v.productImage}`} className='img-fluid' alt="" />
            </Link>
            <Link className="secondary_img" href={`/product-details/${v.slug}`}>
              <img src={`http://localhost:5600/uploads/${v.backImage}`} className='img-fluid' alt="" />
            </Link>
          </div>
          <div className="product_content">
            ...
            <h3><Link href={`/product-details/${v.slug}`}> {v.productName} </Link></h3>
            <div className="price_box">
              <span className="old_price">Rs. {v.actualPrice}</span>
              <span className="current_price">Rs. {v.sellingPrice} </span>
            </div>
